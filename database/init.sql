...
CREATE OR REPLACE TABLE users (
  ...
  INSERT INTO users (email, password, isAdmin, username, fullName, title, phone, skillsDescription, socialSecurityNumber, wallet) VALUES
      ...
      ('student@cqureacademy.com', '$2a$12$ID2plo9wq/shHnGhs.kTG.ImaKIbvgFGv67sUmDURTlY.Pj3y4PM.', false, 'student','Clever Johnny','Trash Can Expert','001 123 321 123','Investigation, collecting','12343234223234','10.00'),
      ('admin@cqureacademy.com', '$2a$12$ID2plo9wq/shHnGhs.kTG.ImaKIbvgFGv67sUmDURTlY.Pj3y4PM.', true, 'admin','Jack the Admin','System Administrator','001 322 312 123','Investigation, collecting, administration','45354353243234','200.00'),

      -- $2a$12$WLF1mB1oL67cpRD9qLKP4.mr1MGPPOivN4UsGbcotmCyBP4am6lru = science
      ('ryland.grace@cqureacademy.com', '$2a$12$WLF1mB1oL67cpRD9qLKP4.mr1MGPPOivN4UsGbcotmCyBP4am6lru', false, 'ryland.grace','Ryland Grace','Trash Can Specialist','001 333 312 123','Analysis, running','3453323423434','300.00'),
      
      -- $2a$12$s/GJRBEDx/XfiSZwmrnWwulzN/vq6yguYPgmnOZFr6PmirEzqaHqe = p0wer!!!
      ('eva.stratt@cqureacademy.com', '$2a$12$s/GJRBEDx/XfiSZwmrnWwulzN/vq6yguYPgmnOZFr6PmirEzqaHqe', true, 'eva.stratt','Eva Stratt','Junior Trash Can Specialist','001 343 312 334','Investigation, administration','666776787687','100.00'),
